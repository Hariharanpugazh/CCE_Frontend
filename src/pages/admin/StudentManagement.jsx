...
const StudentManagement = () => {
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        const response = await axios.get("https://cce-backend.onrender.com/api/students/");
  ...
  const handleDeleteStudent = async (id) => {
    try {
      await axios.delete(`https://cce-backend.onrender.com/api/students/${id}/delete/`);
  ...
  const handleToggleStatus = async (student) => {
    ...
    try {
      await axios.put(`https://cce-backend.onrender.com/api/students/${student._id}/update/`, { status: updatedStatus });
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      await axios.put(`https://cce-backend.onrender.com/api/students/${editableStudent._id}/update/`, editableStudent);
