...
const StudentManagement = () => {
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        const response = await axios.get("https://cce-backend-54k0.onrender.com/api/students/"); // Replace with your API endpoint
  ...
  const toggleStatus = async (student) => {
    try {
      ...
      await axios.put(`https://cce-backend-54k0.onrender.com/api/students/${student._id}/update/`, { status: newStatus });
      setStudents((prev) =>
        prev.map((s) =>
  ...
  const deleteStudent = async (studentId) => {
    try {
      await axios.delete(`https://cce-backend-54k0.onrender.com/api/students/${studentId}/delete/`);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.put(`https://cce-backend-54k0.onrender.com/api/students/${selectedStudent._id}/update/`, validData);
