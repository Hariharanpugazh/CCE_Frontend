...
const StudyEdit = () => {
    ...
    useEffect(() => {
        ...
        fetch(`https://cce-backend.onrender.com/api/study-material/${id}/`)
    ...
    const handleSave = () => {
        fetch(`https://cce-backend.onrender.com/api/study-material-edit/${id}/`, {
            method: 'PUT',
            headers: {
    ...
    const handleDelete = () => {
        if (window.confirm("Are you sure you want to delete this study material?")) {
            fetch(`https://cce-backend.onrender.com/api/study-material-delete/${id}/`, {
                method: 'DELETE'
            })
            .then(response => {
                if (response.ok) {
